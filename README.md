...
##🎮 Chạy ứng dụng
1. **Khởi động Server và Client cùng lúc**

- Sử dụng script run_both.py để chạy cả server và client cùng lúc:python run_both.py


Server sẽ chạy tại: http://localhost:5001
Client sẽ chạy tại: http://localhost:5000
**Hướng dẫn:**
Truy cập http://localhost:5001 để khởi động server socket.
Truy cập http://localhost:5000 để gửi/nhận tin nhắn.
Nhấn Ctrl+C để dừng cả hai ứng dụng.
...
Vào trang "Gửi tin nhắn" và nhập nội dung tin nhắn, sau đó gửi.
